...
xtrain, xtest, ytrain, ytest = train_test_split(x, y, test_size = 0.20, random_state = 80)
print('\nAll is well\n')
...
st.markdown("<h1 style = ' text-align: center;font-family: Arial, Helvetica, sans-serif; '>HOUSE PRICE PREDICTION </h1>", unsafe_allow_html= True)

st.markdown("<h3 style = 'margin: -25px; color: #040D12; text-align: center;font-family: Arial, Helvetica, sans-serif; '> BUILT BY OLAMILEKAN</h3>", unsafe_allow_html= True)
st.image('house pix.png', width = 500)
...
st.sidebar.image('profile.jfif', caption = f'Welcome {username}')
